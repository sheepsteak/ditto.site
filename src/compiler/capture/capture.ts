...
import { collectPage, type PageSnapshot, type FontFace } from "./walker.ts";
import { tagElements, captureInteractions, type InteractionCapture } from "./interactions.ts";
import { captureMotion, probeReveals, type MotionCapture } from "./motion.ts";
import {
...
import { discoverBreakpoints } from "./breakpoints.ts";
import { writeJSON, writeJSONCompact, writeBytes, ensureDir } from "../util/fsx.ts";
import { sha1_12, round } from "../util/canonical.ts";
import { isZipArchive, extractDotLottieJson } from "./dotlottie.ts";
import { buildDeterministicEnvShim, captureEpochMs, DEFAULT_PRNG_SEED } from "../util/envShim.ts";
import { isBotWall, classifyNavFailure } from "../util/captureFailure.ts";
